...
our agent strictly follow the Pass@1 standard in this benchmark（only 12 tasks are reran due to outside factor like process crash caused by disk full）
...
our agent got a final result of **94.2%** pass@1 success rate in the benchmark, and for any-crash, our success rate is 99.0%.
